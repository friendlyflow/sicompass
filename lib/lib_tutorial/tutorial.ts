    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          "All tags support prefix/suffix text: text before and after the tag is preserved.",
          "Example: 'Label: \\<input>value\\</input> (hint)' shows 'Label: ' before and ' (hint)' after.",
          "This works for input, link, image, and button tags.",
          "All elements support \\\\n for multiline content with automatic prefix continuation.",
        ],
      },
    ],
  },
