...
tutorial-prog-web-commands = Web browser commands: clear cookies signs you out of every site, choose language brings back the language choice a site offered, and show hidden content reloads the page with nothing left out, which is the way back if a page reads oddly. A site that asks about your language or its cookies puts those questions first, as steps you answer before the content appears, and nothing is accepted on your behalf.
