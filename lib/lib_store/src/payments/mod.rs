...
//!   user's real browser.
//! - [`tier_input`] — the button, radio and redeem-token handling on a tier
//!   page the Store serves.
//! - [`config`] — the server URL and the redeem tokens, in `settings.json`.
//! - [`entitlement`] — is the cloud subscription currently good?
//! - [`usage`] — the storage and monthly traffic the server reports.
//!
//! None of this is a feature gate. The app is free under GPLv3 and a user's
//! data stays fully readable and editable whether or not they have paid. What
//! a subscription buys is a *service*, storage on our server.
