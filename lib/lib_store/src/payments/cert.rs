...
//! [`crate::payments::entitlement`], and it decides a single thing: whether to send the
...
pub const SLUGS: [&str; 2] = [crate::payments::CLOUD_SLUG, crate::payments::SUPPORT_SLUG];
