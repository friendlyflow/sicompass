...
store-data-waiting-root = Nicht installiert, mit Ihren Daten auf diesem Computer: { $names }. Notizen und Projektverwaltung waren früher in sicompass enthalten und kommen jetzt aus dem Store. Installieren Sie sie unter Programme, um Ihre Daten wieder zu öffnen.
