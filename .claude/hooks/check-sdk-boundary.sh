...
LIB_CRATES='filebrowser|settings|chatclient|emailclient|webbrowser|tutorial|shell|terminal|claude|gitclient|notes|project_management|payments|text_editor|builtins|updater'
