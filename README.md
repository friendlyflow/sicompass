...
| Debian, Ubuntu, Mint | [sicompass_0.1.20_amd64.deb](https://github.com/friendlyflow/sicompass/releases/latest/download/sicompass_0.1.20_amd64.deb) |
| Fedora, RHEL, openSUSE | [sicompass-0.1.20-1.x86_64.rpm](https://github.com/friendlyflow/sicompass/releases/latest/download/sicompass-0.1.20-1.x86_64.rpm) |
| Any Linux, no root | [sicompass_0.1.20_x86_64.AppImage](https://github.com/friendlyflow/sicompass/releases/latest/download/sicompass_0.1.20_x86_64.AppImage) |
...
```bash
sudo apt install ./sicompass_0.1.20_amd64.deb      # Debian, Ubuntu, Mint
sudo dnf install ./sicompass-0.1.20-1.x86_64.rpm   # Fedora, RHEL, openSUSE
```

The AppImage needs no root. Make it executable and run it:

```bash
chmod +x sicompass_0.1.20_x86_64.AppImage
./sicompass_0.1.20_x86_64.AppImage
```
